# Cookiecutter SAM for {{cookiecutter.project_name}} Lambda functions
...
Generate a new SAM based Serverless App: `cookiecutter gh:aws-samples/{{cookiecutter.project_slug}}`.
